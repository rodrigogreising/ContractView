...
description: Use when Codex needs to review ContractView SDLC evidence for Architecture and ADR review, including Linear-controlled work before it leaves In Review or reaches Done.
---

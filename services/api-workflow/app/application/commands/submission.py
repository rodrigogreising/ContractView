...
def submit(actor:Actor,invoice_id:str)->dict:
    ...
    def command():
        ...
        with database() as connection:
            ...
            connection.workflow.execute(Statement.SUBMISSION_WRITE_SUBMISSIONS_005,(submission_id,invoice_id,package[0],actor.user_id,actor.role.value,invoice[2],invoice[3],json.dumps(dict(hashes))))
